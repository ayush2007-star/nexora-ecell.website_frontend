...
export default function Register() {
  ...
  const loadPublicEvents = async () => {
    try {
      ...
      if (Array.isArray(data) && data.length > 0) {
        ...
        // If query parameter is provided, select that event.
        if (queryEventId) {
          const match = data.find(
            (event) => event.eventId === queryEventId
          );
      ...
      console.error(
        "Could not fetch dynamic events, using default presets.",
        err
      );
    }
  };
  ...
  const selectedEventObj = events.find(
    (event) => event.eventId === form.eventId
  );

  const maxTeamSize = selectedEventObj?.maxTeamSize ?? 3;
  const maxAdditionalMembers = Math.max(0, maxTeamSize - 1);

  const handleEventSelect = (e) => {
    const selectedId = e.target.value;

    const selectedObj = events.find(
      (event) => event.eventId === selectedId
    );

    const newMaxTeamSize = selectedObj?.maxTeamSize ?? 3;
    const newMaxAdditional = Math.max(0, newMaxTeamSize - 1);

    setForm((prev) => ({
      ...prev,
      eventId: selectedId,
      eventName: selectedObj
        ? selectedObj.title
        : "Nexora Ideathon 2026",

      // Trim team members if the newly selected event has a smaller limit.
      teamMembers: prev.teamMembers.slice(0, newMaxAdditional),
    }));
  ...
  const addMember = () => {
    if (maxAdditionalMembers === 0) {
      setError(
        "This event is configured for solo / individual participants only."
      );
      return;
    }

    if (form.teamMembers.length >= maxAdditionalMembers) {
      setError(
        `This event allows a maximum of ${maxAdditionalMembers} additional team member(s) (Total team size: ${maxTeamSize}).`
      );
      return;
    }
  ...
  const copyTeamId = async (id) => {
    ...
    try {
      ...
      console.error("Could not copy Team ID:", err);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/v1/registration/`,
        {
          method: "POST",
          headers: {
      ...
      <main className="register-page">
        ...
        <div className="register-shell">
          ...
          <div className="register-success-card">
            ...
            <p>
              Your team <strong>"{teamName}"</strong> has been
              registered for{" "}
              <strong>{form.eventName}</strong>. Save your unique
              Team ID to track your status.
            </p>
            ...
            <div className="team-id-box">
              ...
              <small>
                Use this ID to check application review progress
    ...
    <main className="register-page">
      ...
      <div className="register-shell">
        ...
        <header className="register-header">
          ...
          <p>
            Complete all details to submit your proposal to
            NEXORA E-CELL judges, accelerator mentors, and
            incubation panel.
          </p>
        </header>
        ...
        <form
          ...
          className="register-card luxury-card"
        >
          {/* =========================================================
          ...
          <section className="form-section highlight-event-section">
            <div className="form-step-heading">
              ...
              <div className="step-text-wrap">
                ...
                <p>
                  Choose which hackathon, bootcamp, or initiative
                  you are entering.
                </p>
              </div>
            </div>
                    ...
                    {events.length > 0 ? (
                      ...
                      <>
                        <option value="EVT-IDEATHON-2026">
                          Nexora Ideathon 2026 (Flagship
                          Hackathon) — ₹2,50,000
                        </option>

                        <option value="EVT-BOOTCAMP-2026">
                          Founders Bootcamp & Pitch Lab
                          (Workshop)
                        </option>

                        <option value="EVT-ESUMMIT-2026">
                          Nexora E-Summit & Pitch Battle —
                          ₹5,00,000
                        </option>
              ...
              <div className="event-info-pill">
                ...
                <div className="event-info-item">
                  ...
                  <span>
                    ...
                    {maxTeamSize === 1
                      ? "Solo Only (1 Member)"
                      : `Max ${maxTeamSize} (Leader + ${maxAdditionalMembers} Members)`}
                  </span>
                </div>
                ...
                <div className="event-info-item">
                  ...
                  <span>
                    ...
                    {selectedEventObj.registrationDeadline ||
                      "Open"}
                  </span>
                </div>
              </div>
          ...
          <section className="form-section">
            <div className="form-step-heading">
              ...
              <div className="step-text-wrap">
                ...
                <p>
                  Primary point of contact for review
                  communications.
                </p>
              </div>
            </div>
              ...
              <div className="field-group">
                ...
                <div className="custom-select-wrapper">
                  ...
                  >
                    ...
                    <option value="Post Graduate / Alumni">
          ...
          <section className="form-section">
            <div className="form-step-heading">
              ...
              <div className="step-text-wrap">
                ...
                <p>
                  Explain the innovation, target audience, and
                  progress.
                </p>
              </div>
            </div>
            ...
            <div className="grid-2">
              ...
              <div className="field-group">
                ...
                <div className="custom-select-wrapper">
                  ...
                  >
                    ...
                    <option value="FinTech & Web3">
                      FinTech & Web3
                    </option>

                    <option value="HealthTech & BioTech">
                      HealthTech & BioTech
                    </option>
                    ...
                    <option value="EdTech & Skill Development">
                      EdTech & Skill Development
                    </option>

                    <option value="AgriTech & Rural Solutions">
                      AgriTech & Rural Solutions
                    </option>

                    <option value="Robotics, Drones & IoT">
                      Robotics, Drones & IoT
                    </option>

                    <option value="Consumer Tech & SaaS">
                      Consumer Tech & SaaS
                    </option>

                    <option value="Other DeepTech">
                      Other DeepTech
                    </option>
                  </select>
                </div>
              ...
              <div className="field-group full-width">
                ...
                <div className="custom-select-wrapper">
                  <select
                    ...
                    className="custom-select"
                  >
                    <option value="Idea / Concept Validation">
                      Idea / Concept Validation
                    </option>

                    <option value="Prototype / MVP Developed">
                      Prototype / MVP Developed
                    </option>

                    <option value="Early Traction (Beta Users)">
                      Early Traction (Beta Users)
                    </option>

                    <option value="Revenue Generating / Scaled">
                      Revenue Generating / Scaled
                    </option>
                  </select>
                </div>
              </div>
              ...
              <div className="field-group full-width">
                <label htmlFor="description">
                  Executive Summary / Description (Min 20
                  characters) *
                </label>
          ...
          <section className="form-section">
              ...
              <div className="step-text-wrap">
                <h2>
                  {maxAdditionalMembers === 0
                    ? "Team Members (Solo / Individual Event)"
                    : `Team Members (Up to ${maxAdditionalMembers} Additional)`}
                </h2>

                <p>
                  {maxAdditionalMembers === 0
                    ? "This event is configured for single participant entry (Solo only)."
                    : `Add co-founders or key team contributors (Maximum team size: ${maxTeamSize} including Leader).`}
                </p>
              </div>
            </div>
            ...
            {maxAdditionalMembers === 0 ? (
              <div className="empty-member-box">
                <p>
                  ⚡ This event is configured by admin for
                  individual / solo participation. No extra
                  members needed.
                </p>
              </div>
              ...
              <div className="empty-member-box">
                <p>
                  No additional team members added. (Solo
                  entries are also accepted)
                </p>

                <button
                  type="button"
                  className="button button-ghost button-small add-member-btn"
                  onClick={addMember}
                >
                  + Add Team Member
                </button>
          ...
          <section className="form-section">
            <div className="form-step-heading">
              ...
              <div className="step-text-wrap">
                ...
                <p>
                  Link your presentation slides and partner
            ...
            <div className="grid-2">
              <div className="field-group">
                <label htmlFor="eurekaTeamId">
                  Eureka / Partner Team ID *
                </label>
                ...
                <input
                  ...
                  value={
                    form.eCellVerification.eurekaTeamId
                  }
              ...
              <div className="field-group">
                ...
                <input
                  ...
                  value={
                    form.eCellVerification.referralCodeUsed
                  }
                  onChange={updateVerification}
                />
              </div>
              ...
              <div className="field-group full-width">
                <label htmlFor="pitchDeckUrl">
                  Pitch Deck Link (Google Drive / Canva /
                  Notion) *
                </label>
                ...
                <input
                  ...
                  value={
                    form.eCellVerification.pitchDeckUrl
                  }
                  onChange={updateVerification}
                />

                <small className="field-tip">
                  Ensure share link permissions are set to
